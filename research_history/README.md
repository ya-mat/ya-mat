...
### 論文（査読あり）
1. Y Matsumoto, [Fast wavefield evaluation method based on modified proxy-surface-accelerated interpolative decomposition for two-dimensional scattering problems](https://www.jstage.jst.go.jp/article/jsiaml/16/0/16_61/_article/-char/ja/), JSIAM Letters 16, 61-64.
...
### 国内学会発表等
1. 松本安弘, proxy法に基づくほぼ線型の時間複雑性の高速直接境界要素法, 第46回計算数理工学フォーラム, 9月27日, 東京, 2024.（**招待講演**）
